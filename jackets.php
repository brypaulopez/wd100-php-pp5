...
<body>
    ...
    <?php
        ...
        ?>
    <!-- Main body -->
    <h1 class="hpurple text-center mt-3">Jackets</h1>
    <div class="container text-center">
    <img src="img/jackets-bg.webp" alt="" class="w-75 m-auto rounded-pill bpurple">
        <div class="row g-5 mt-5">
            <?php
                include "doodles-db.php";
                $sqlBatch = "SELECT * FROM products_tbl WHERE Product_Category = 'Jackets'";
                ...
                while ($batchShow = $resultBatch->fetch_assoc()) {
                    ...
                    <div class='col-3 col-xl-3 col-lg-4 col-md-6 col-12'>
                        <form method='POST' action='all-product-getter.php'>
                            <div class='card cpurple orange text-center m-auto' style='width: 18rem;color: black !important;'>
                                <img src='img/$batchShow[Product_Image]' class='card-img-top' alt='...'>
                                <div class='card-body'>
                                <h5 class='card-title hpurple fs-3'>$batchShow[Product_Name]</h5>
                                <p class='card-text'>&#8369;$batchShow[Product_Price]</p>
                                <input type='hidden' name='id' value='$batchShow[Product_ID]'> 
                                <input class='btn bgreen purple' type='submit' value='Buy Now' name='Order'>
                                </div>
                            </div>
                        </form>
                    </div>
